...
<div class="nav navbar-default " style="background-color:white;">
			...
			<?php
				...
				if(loggedin() || adminloggedin()){
					...
					if(adminloggedin()) echo "<li id='pro'><a href='admin-profile.php' style='font-family:branchFont;'>Dashboard</a></li>";
		...
		<noscript style="text-align:center;">
			<div class="alert alert-danger" style="margin-bottom:0%; font-family: 'Open Sans', sans-serif;">Javascript must be enabled in order for you to use all the features of this site. This site works best when javascript is enabled </div>
		</noscript>
</html>
