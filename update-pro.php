...
if(loggedin()){
		...
		$query = "SELECT * from $branch WHERE $idTerm = $id";
		...
		$classNum = $row['classNum']; $tenthM=$row['tenth'];

		if(isset($_row['twelthM']) >= 0)
			$twelthM=$row['twelthM'];
		if(isset($_row['deplomaM']) >= 0)
			$deplomaM = $row['deplomaM'];

		$email = $row['email'];
		$contact = $row['contact'];
		$add = $row['address'];
		$sem1= $row['sem1M']; $sem2 = $row['sem2M'];
		$sem3=$row['sem3M']; $sem4=$row['sem4M']; $sem5=$row['sem5M']; $sem6=$row['sem6M'];
		$eCurri = $row['extra-curri'];
		$coCurri = $row['co-curri'];
		$gapAnswer = $row['gap'];
			...
			<div class="well" style="background-color:white;">
						...
						<div class="form-group" style="">
						  <div class=" col-xs-4">
							...
							<input type="text"  name="first_name" value="<?php if(isset($first_name)) echo $first_name;?>" placeholder="" class="form-control">
						  </div>
						</div>
						...
						<div class="form-group">
							<div class="col-xs-4">
								...
								<input type="text"  name="middle_name" value="<?php if(isset($middle_name)) echo $middle_name;?>" placeholder="" class="form-control">
							</div>
						</div>
						...
						<div class="form-group">
						 <div class="col-xs-4">
							...
							<input type="text"  name="last_name" value=" <?php if(isset($last_name)) echo $last_name;?>" placeholder="" class="form-control">
						  </div>
						</div>
						...
						<div class="form-group" style="">
						  ...
						  <div class="controls">
							<input type="date" name="dob" value="<?php if(isset($dob)) echo $dob;?>" placeholder="" class="form-control">
						  </div>
						</div>
			...
			<div class="well" style="background-color:white">
						...
						<div class="form-group">
						  <label >Registration Id:</label>
							<input type="text" class="form-control" name="regId" value="<?php if(isset($regId)) echo $regId;?>"/>
						</div>
						...
						<div class="form-group">
						  <div class="col-md-6">
							...
							<select name="adyear" class="form-control"  >
								<option <?php if(!isset($branch)) echo "selected" ?> disabled selected> --Select Year-- </option>
								<option  <?php echo ($adyear == '2010-11')?"selected":"" ?>  value="2010-11">2010-11</option>
								<option  <?php echo ($adyear == '2011-12')?"selected":"" ?>  value="2011-12">2011-12</option>
								<option  <?php echo ($adyear == '2012-13')?"selected":"" ?>  value="2012-13">2012-13</option>
								<option  <?php echo ($adyear == '2013-14')?"selected":"" ?>  value="2013-14">2013-14</option>
								<option  <?php echo ($adyear == '2014-15')?"selected":"" ?>  value="2014-15">2014-15</option>
								<option  <?php echo ($adyear == '2015-16')?"selected":"" ?>  value="2015-16">2015-16</option>
							</select>
							</div>
						</div>
						...
						<div class="form-group">
						  <div class="col-md-6">
							...
							<select class="form-control"  id="element_3" name="branch">
								<option <?php if(!isset($branch)) echo "selected" ?> >--Select branch-- </option>
								<option <?php echo ($branch == 'CIVIL')?"selected":"" ?> value="CIVIL" >CIVIL</option>
								<option <?php echo ($branch == 'MECHANICAL')?"selected":"" ?> value="MECHANICAL" >MECHANICAL</option>
								<option <?php echo ($branch == 'CSE')?"selected":"" ?> value="CSE" >CSE</option>
								<option <?php echo ($branch == 'IT')?"selected":"" ?> value="IT" >IT</option>
								<option <?php echo ($branch == 'CHEMICAL')?"selected":"" ?> value="CHEMICAL" >CHEMICAL</option>
								<option <?php echo ($branch == 'BIOTECH')?"selected":"" ?> value="BIOTECH" >BIOTECH</option>
								<option <?php echo ($branch == 'E&TC')?"selected":"" ?> value="EXTC" >E&TC </option>
								<option <?php echo ($branch == 'EEP')?"selected":"" ?> value="EEP" >EEP</option>
								<option <?php echo ($branch == 'INSTRUMENTATION')?"selected":"" ?> value="INSTRUMENTATION" >INSTRUMENTATION</option>
								<option <?php echo ($branch == 'MCA')?"selected":"" ?> value="mca" >MCA</option>
								<option <?php echo ($branch == 'Architecture')?"selected":"" ?> value= "architecture">Architecture</option>
							</select>
						  </div>
						</div>
						...
						<div class="form-group">
						  ...
						  <label class="control-label">Year</label>
							<select name="year"  id="yearID" class="form-control" onchange='num_fields(this.value);'>
								<option <?php if(!isset($branch)) echo "selected" ?>  disabled selected> --Select Year-- </option>
								<option <?php echo ($year == '2nd')?"selected":"" ?>  value="1">2nd</option>
								<option <?php echo ($year == '3nd')?"selected":"" ?> value="2">3rd</option>
								<option <?php echo ($year == '4nd')?"selected":"" ?> value="3">4th</option>
							</select>
							<div >
								<input type="text" class="form-control" value="<?php if(isset($sem1)) echo $sem1;?>" name="sem1" id='s1' style="display:none;" placeholder="Semester 1 (Leave it blank if direct 2nd year)">
								<input type="text" class="form-control" value="<?php if(isset($sem2)) echo $sem2;?>" id='s2' name="sem2" style="display:none;;" placeholder="Semester 2 (Leave it blank if direct 2nd year)">
								<input type="text" class="form-control" value="<?php if(isset($sem3)) echo $sem3;?>" id='s3' name="sem3" style="display:none;;" placeholder="Semester 3">
								<input type="text" class="form-control" value="<?php if(isset($sem4)) echo $sem4;?>" id='s4' name="sem4" style="display:none;" placeholder="Semester 4">
								<input type="text" class="form-control" value="<?php if(isset($sem5)) echo $sem5;?>" id='s5' name="sem5" style="display:none;" placeholder="Semester 5 ">
								<input type="text" class="form-control" value="<?php if(isset($sem6)) echo $sem6;?>" id='s6' name="sem6" style="display:none;" placeholder="Semester 6 (optional)">
						 ...
						 <div class="form-group" id="gapSelectID" style="display:none">
						  <div class="col-md-6">
							<select name="gapSelect"  class="form-control"  >
								<option selected="selected" disabled selected> --Specify Year of gap-- </option>
						...
						<div class="form-group" style="margin-top:1%">
							...
							<input step="any" type="number"  placeholder="Enter percentage" class="form-control" name="tenth" value="<?php if(isset($tenthM)) echo $tenthM;?> ">
						 </div>
						...
						<div id="twelth-input" style="display:none" >
							<input type="number" step="any" name="twelthM" class="form-control " placeholder = "Enter percentage" value="<?php if(isset($twelthM)) if($twelthM != -1.00)echo $twelthM;?>"/>
						</div>
						<div class="form-group">
